...
analysis = Analysis([str(root/'desktop.py')], pathex=[str(root)],
    ...
    hiddenimports=['server','multicam_edit','effects','numpy','scipy.signal','scipy.ndimage','AppKit','Foundation'],
...
app = BUNDLE(collect, name='Multicam Studio.app', bundle_identifier='com.multicamstudio.desktop',
    version='1.1.0', icon=str(root/'packaging/MulticamStudio.icns'), info_plist={'CFBundleShortVersionString':'1.1.0','CFBundleVersion':'1.1.0','LSMinimumSystemVersion':'14.0',
